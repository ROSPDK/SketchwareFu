...
public class ViewBeans {
    ...
    public static final int VIEW_TYPE_WIDGET_NESTEDSCROLLVIEW = 25;
    public static final int VIEW_TYPE_WIDGET_GRIDVIEW = 26;
    ...
    public static final int VIEW_TYPE_WIDGET_EXTENDEDFAB = 30;   
    public static final int VIEW_TYPE_WIDGET_FAB = 31;
    public static final int VIEW_TYPE_WIDGET_FRA_LAYOUT = 32;
    public static final int VIEW_TYPE_LAYOUT_TABLAYOUT = 33;
    public static final int VIEW_TYPE_LAYOUT_VIEWPAGER = 34;
    public static final int VIEW_TYPE_LAYOUT_BOTTOMNAVIGATIONVIEW = 35;
    public static final int VIEW_TYPE_WIDGET_BADGEVIEW = 36;
    public static final int VIEW_TYPE_WIDGET_PATTERNLOCKVIEW = 37;
    public static final int VIEW_TYPE_WIDGET_WAVESIDEBAR = 38;
    public static final int VIEW_TYPE_LAYOUT_CARDVIEW = 39;
    public static final int VIEW_TYPE_LAYOUT_COLLAPSINGTOOLBARLAYOUT = 40;
    public static final int VIEW_TYPE_LAYOUT_TEXTINPUTLAYOUT = 41;
    ...
    public static final int VIEW_TYPE_WIDGET_SIGNINBUTTON = 50;
    public static final int VIEW_TYPE_WIDGET_CIRCLEIMAGEVIEW = 51;
    public static final int VIEW_TYPE_WIDGET_LOTTIEANIMATIONVIEW = 52;
    public static final int VIEW_TYPE_WIDGET_YOUTUBEPLAYERVIEW = 53;
    public static final int VIEW_TYPE_WIDGET_OTPVIEW = 54;
    public static final int VIEW_TYPE_WIDGET_CODEVIEW = 55;
    public static final int VIEW_TYPE_WIDGET_RECYCLERVIEW = 56;
    public static final int VIEW_TYPE_WIDGET_REL_LAYOUT = 57; 
    ...
    static BiMap<Integer, String> views = new ImmutableBiMap.Builder<Integer, String>()
            ...
            .put(VIEW_TYPE_WIDGET_NESTEDSCROLLVIEW, "NestedScrollView")
            ...
            .put(VIEW_TYPE_WIDGET_EXTENDEDFAB, "MaterialExtendedFab")   
            .put(VIEW_TYPE_WIDGET_FAB, "MaterialFab")
            .put(VIEW_TYPE_WIDGET_FRA_LAYOUT, "FrameLayout")
            ...
            .put(VIEW_TYPE_LAYOUT_COLLAPSINGTOOLBARLAYOUT, "CollapsingToolbar")
            ...
            .put(VIEW_TYPE_WIDGET_MATERIALCHIP, "MaterialChip")
            .put(VIEW_TYPE_WIDGET_MATERIALCHIPGROUP, "MaterialChipGroup")
            .put(VIEW_TYPE_WIDGET_MATERIALSLIDER, "MaterialSlider")
            ...
            .put(VIEW_TYPE_WIDGET_LOTTIEANIMATIONVIEW, "LottieAnimation")
            .put(VIEW_TYPE_WIDGET_YOUTUBEPLAYERVIEW, "YouTubePlayer")
            .put(VIEW_TYPE_WIDGET_OTPVIEW, "OTPView")
            .put(VIEW_TYPE_WIDGET_CODEVIEW, "CodeView")
            .put(VIEW_TYPE_WIDGET_RECYCLERVIEW, "RecyclerView")
            .put(VIEW_TYPE_WIDGET_REL_LAYOUT, "RelativeLayout")
            .build();

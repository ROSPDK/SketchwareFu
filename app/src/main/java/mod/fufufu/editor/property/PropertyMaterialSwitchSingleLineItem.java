...
public class PropertyMaterialSwitchSingleLineItem extends LinearLayout implements View.OnClickListener {
    ...
    private void initialize(Context context, boolean z) {
        wB.a(context, this, R.layout.property_material_switch_item_singleline);

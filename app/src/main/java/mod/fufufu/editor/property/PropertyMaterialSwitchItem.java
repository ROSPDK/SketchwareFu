...
public class PropertyMaterialSwitchItem extends RelativeLayout implements View.OnClickListener {
    ...
    private void initialize(Context context) {
        wB.a(context, this, R.layout.property_material_switch_item);

...
public class ItemMaterialExtendedFab extends LinearLayout implements sy {
    ...
    public ItemMaterialExtendedFab(Context context) {
        super(context);
        ...
        imageView.setImageResource(R.drawable.item_exended_fab);

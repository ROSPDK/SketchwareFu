...
public class FirebaseActivity extends BaseAppCompatActivity implements View.OnClickListener {
    ...
    private void setStep(int stepNumber) {
        ...
        if (stepNumber == STEP_1) {
            ...
            private AdvancedFirebaseReviewStep kvVar = new AdvancedFirebaseReviewStep(this);
    ...
    private void showGetChromeDialog() {
        ...
        dialog.b(getTranslatedString(R.string.common_word_ok), (d, which) -> {
            if (!mB.a()) {
                Intent intent = new Intent(Intent.ACTION_VIEW);
        ...
        dialog.a(getTranslatedString(R.string.common_word_cancel), (d, which) -> Helper.getDialogDismissListener(d));
        dialog.show();
    }
}

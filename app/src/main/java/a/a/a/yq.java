...
public void monet(Context context) {
    ...
    public ArrayList<SrcCodeBean> a(hC projectFileManager, eC projectDataManager, BuiltInLibraryManager builtInLibraryManager) {
        ...
        ResourceHandler resourceHandler = new ResourceHandler(SketchApplication.getContext(), sc_id);

        srcCodeBeans.add(new SrcCodeBean("styles.xml",
                CommandBlock.applyCommands("styles.xml", resourceHandler.getXmlStyle())));

        srcCodeBeans.add(new SrcCodeBean("colors.xml",
                CommandBlock.applyCommands("colors.xml", resourceHandler.getXmlColor())));

        srcCodeBeans.add(new SrcCodeBean("strings.xml",
                CommandBlock.applyCommands("strings.xml", resourceHandler.getXmlString())));
        CommandBlock.x();
        return srcCodeBeans;
    }
